...
import com.github.barteksc.pdfviewer.C0761R;
...
public class DefaultScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public void setupLayout(PDFView pdfView2) {
        ...
        if (pdfView2.isSwipeVertical()) {
            ...
            if (this.inverted) {
                align = 9;
                background = ContextCompat.getDrawable(this.context, C0761R.C0762drawable.default_scroll_handle_left);
            } else {
                align = 11;
                background = ContextCompat.getDrawable(this.context, C0761R.C0762drawable.default_scroll_handle_right);
            }
        } else {
            width = 40;
            height = 65;
            if (this.inverted) {
                align = 10;
                background = ContextCompat.getDrawable(this.context, C0761R.C0762drawable.default_scroll_handle_top);
            } else {
                align = 12;
                background = ContextCompat.getDrawable(this.context, C0761R.C0762drawable.default_scroll_handle_bottom);
            }
        }
