...
final class zzaz {
    ...
    public static Map<String, Object> zzb(String str) {
        ...
        if (zzd.size() < 2) {
            ...
            logger.mo12405e(valueOf.length() != 0 ? "Invalid idToken ".concat(valueOf) : new String("Invalid idToken "), new Object[0]);
            return new HashMap();
        }
        try {
            ...
            zza.mo12404e("Unable to decode token", e, new Object[0]);
            return new HashMap();
        }
    }
