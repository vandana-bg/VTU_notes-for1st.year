...
public final class zzf {
    ...
    public final Task<zze> zza(FirebaseAuth firebaseAuth, String str, Activity activity, boolean z) {
        ...
        if (safetyNetClient == null || zzw.zzc()) {
            ...
            safetyNetClient.attest(bArr, app.getOptions().getApiKey()).addOnSuccessListener(new zzb(this, taskCompletionSource, firebaseAuth, zzc, activity)).addOnFailureListener(new zza(this, firebaseAuth, zzc, activity, taskCompletionSource));
        }
