...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        result.add(LibraryVersionComponent.fromContext(TARGET_SDK, $$Lambda$FirebaseCommonRegistrar$5KXEd3fUx19CnAZSAZ0M1s9qGg.INSTANCE));
        result.add(LibraryVersionComponent.fromContext(MIN_SDK, $$Lambda$FirebaseCommonRegistrar$lmqwsm474glUdjxQuX0286DJQr0.INSTANCE));
        result.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, $$Lambda$FirebaseCommonRegistrar$sUt18gVyvEV5RL6q8HJBhUltbQU.INSTANCE));
        result.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, $$Lambda$FirebaseCommonRegistrar$4z_FoKjSmKejlSwMYYMZeC7LsMo.INSTANCE));
