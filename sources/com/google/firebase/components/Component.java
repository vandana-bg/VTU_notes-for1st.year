...
public final class Component<T> {
    ...
    public static <T> Component<T> m37of(Class<T> anInterface, T value) {
        return builder(anInterface).factory(new ComponentFactory(value) {
    ...
    public static <T> Component<T> m38of(T value, Class<T> anInterface, Class<? super T>... additionalInterfaces) {
        return builder(anInterface, additionalInterfaces).factory(new ComponentFactory(value) {
            public final /* synthetic */ Object f$0;
    ...
    public static <T> Component<T> intoSet(T value, Class<T> anInterface) {
        return intoSetBuilder(anInterface).factory(new ComponentFactory(value) {
            public final /* synthetic */ Object f$0;
