...
class zzabv<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzabs> zzb = Collections.emptyList();
    /* access modifiers changed from: private */
    public Map<K, V> zzc = Collections.emptyMap();
    private boolean zzd;
    private volatile zzabu zze;
    private Map<K, V> zzf = Collections.emptyMap();

    /* synthetic */ zzabv(int i, zzabo zzabo) {
        this.zza = i;
    }
    ...
    public final V zzl(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            List<zzabs> list = this.zzb;
            Map.Entry entry = (Map.Entry) it.next();
            list.add(new zzabs(this, (Comparable) entry.getKey(), entry.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzabu(this, (zzabo) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzabv.zzb()) {
            return entrySet().equals(zzabv.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzabv.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzabv.zzc);
        }
        return true;
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzabs remove = this.zzb.remove(i2 - 1);
            zzm().put(remove.zza(), remove.getValue());
        }
        this.zzb.add(i, new zzabs(this, k, v));
        return null;
    }
