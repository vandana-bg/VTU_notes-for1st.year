                ...
                case 0:
                    ...
                    if (zzvm != null) {
                        ...
                        if (zzvm.zze != null) {
                            ...
                            zzvn.zza.mo12405e("Unable to extract verification code.", new Object[0]);
                            break;
                        }
                    } else {
                        zzvn.zza.mo12405e("Verification code received with no active retrieval session.", new Object[0]);
                        break;
                    }
                    break;
            }
