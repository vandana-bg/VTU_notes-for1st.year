...
final class zzvn {
    ...
    private static String zzm(String str, String str2) {
        ...
        try {
            ...
            logger.mo12403d(sb3.toString(), new Object[0]);
            return substring;
        } catch (NoSuchAlgorithmException e) {
            Logger logger2 = zza;
            String valueOf = String.valueOf(e.getMessage());
            logger2.mo12405e(valueOf.length() != 0 ? "NoSuchAlgorithm: ".concat(valueOf) : new String("NoSuchAlgorithm: "), new Object[0]);
            return null;
        }
    }
    ...
    public final void zzn(String str) {
        ...
        if (zzvm != null && !zzvm.zzh && !zzaf.zzd(zzvm.zzd)) {
            zza.mo12412w("Timed out waiting for SMS.", new Object[0]);
    ...
    public final String zzc() {
        ...
        try {
            ...
            zza.mo12405e("Hash generation failed.", new Object[0]);
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            zza.mo12405e("Unable to find package to obtain hash.", new Object[0]);
            return null;
        }
    }
    ...
    public final void zzk(String str, zztl zztl, long j, boolean z) {
        ...
        zzvm zzvm = this.zzd.get(str);
        if (zzvm.zza <= 0) {
            zza.mo12412w("Timeout of 0 specified; SmsRetriever will not start.", new Object[0]);
            return;
        }
        zzvm.zzf = this.zzc.schedule(new zzvi(this, str), zzvm.zza, TimeUnit.SECONDS);
        if (!zzvm.zzc) {
            zza.mo12412w("SMS auto-retrieval unavailable; SmsRetriever will not start.", new Object[0]);
            return;
        }
