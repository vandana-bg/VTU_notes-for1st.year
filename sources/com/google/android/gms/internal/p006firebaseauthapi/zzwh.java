                    ...
                    if (optJSONArray.length() != 0) {
                        ...
                        while (i2 < optJSONArray.length()) {
                            ...
                            if (jSONObject2 == null) {
                                ...
                                zzwj = new zzwj(emptyToNull, emptyToNull2, optBoolean, emptyToNull3, emptyToNull4, zza2, emptyToNull5, emptyToNull6, optLong, jSONObject2.optLong("lastLoginAt", 0), false, (zze) null, zzwu.zzf(jSONObject2.optJSONArray("mfaInfo")));
                            }
                            arrayList.add(zzwj);
                            i2 = i + 1;
                            z = false;
