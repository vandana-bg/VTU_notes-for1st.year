...
interface zzabk {
    ...
    @Deprecated
    <T> void zzC(List<T> list, zzabl<T> zzabl, zzzj zzzj) throws IOException;

    void zzD(List<Integer> list) throws IOException;

    void zzE(List<Long> list) throws IOException;

    <T> void zzF(List<T> list, zzabl<T> zzabl, zzzj zzzj) throws IOException;
    ...
    zzyu zzp() throws IOException;

    @Deprecated
    <T> T zzr(zzabl<T> zzabl, zzzj zzzj) throws IOException;

    <T> T zzs(zzabl<T> zzabl, zzzj zzzj) throws IOException;
    ...
    void zzw(List<zzyu> list) throws IOException;
