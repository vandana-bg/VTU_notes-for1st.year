...
public final class zztn extends GmsClient<zzua> implements zztm {
    ...
    public final String getStartServicePackage() {
        if (this.zzg.zza) {
            zze.mo12408i("Preparing to create service connection to fallback implementation", new Object[0]);
            return this.zzf.getPackageName();
        }
        zze.mo12408i("Preparing to create service connection to gms implementation", new Object[0]);
