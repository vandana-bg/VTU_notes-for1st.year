    ...
    private final zzl zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                if (!zza.zzap || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || !zzc.zza(str2, zzg, false, true).zzap) {
                    zzl = zza;
                } else {
                    zzl = zzl.zzb("debuggable release cert app rejected");
                }
            }
            if (zzl.zzap) {
                this.zzau = str;
