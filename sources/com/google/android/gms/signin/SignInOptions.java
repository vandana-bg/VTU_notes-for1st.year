...
public final class SignInOptions implements Api.ApiOptions.Optional {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zasm != signInOptions.zasm || this.zasn != signInOptions.zasn || !Objects.equal(this.zaso, signInOptions.zaso) || this.zasp != signInOptions.zasp || this.zass != signInOptions.zass || !Objects.equal(this.zasq, signInOptions.zasq) || !Objects.equal(this.zasr, signInOptions.zasr) || !Objects.equal(this.zast, signInOptions.zast) || !Objects.equal(this.zasu, signInOptions.zasu)) {
            return false;
        }
        return true;
    }
