...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0774R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, (AttributeSet) null, C0774R.attr.materialTimePickerStyle, C0774R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0774R.styleable.MaterialTimePicker, C0774R.attr.materialTimePickerStyle, C0774R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C0774R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C0774R.styleable.MaterialTimePicker_keyboardIcon, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup root = (ViewGroup) layoutInflater.inflate(C0774R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView2 = (TimePickerView) root.findViewById(C0774R.C0777id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) root.findViewById(C0774R.C0777id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C0774R.C0777id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C0774R.C0777id.header_title);
        ...
        ((Button) root.findViewById(C0774R.C0777id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) root.findViewById(C0774R.C0777id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0774R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0774R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C0774R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;
