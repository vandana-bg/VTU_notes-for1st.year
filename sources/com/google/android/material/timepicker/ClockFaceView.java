...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attrs) {
        this(context, attrs, C0774R.attr.materialClockStyle);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0774R.styleable.ClockFaceView, defStyleAttr, C0774R.style.Widget_MaterialComponents_TimePicker_Clock);
        Resources res = getResources();
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, a, C0774R.styleable.ClockFaceView_clockNumberTextColor);
        this.textColor = colorStateList;
        LayoutInflater.from(context).inflate(C0774R.layout.material_clockface_view, this, true);
        ClockHandView clockHandView2 = (ClockHandView) findViewById(C0774R.C0777id.material_clock_hand);
        this.clockHandView = clockHandView2;
        this.clockHandPadding = res.getDimensionPixelSize(C0774R.dimen.material_clock_hand_padding);
        ...
        int defaultBackgroundColor = AppCompatResources.getColorStateList(context, C0774R.C0775color.material_timepicker_clockface).getDefaultColor();
        ColorStateList backgroundColor = MaterialResources.getColorStateList(context, a, C0774R.styleable.ClockFaceView_clockFaceBackgroundColor);
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                int index = ((Integer) host.getTag(C0774R.C0777id.material_value_index)).intValue();
                if (index > 0) {
        ...
        this.minimumHeight = res.getDimensionPixelSize(C0774R.dimen.material_time_picker_minimum_screen_height);
        this.minimumWidth = res.getDimensionPixelSize(C0774R.dimen.material_time_picker_minimum_screen_width);
        this.clockSize = res.getDimensionPixelSize(C0774R.dimen.material_clock_size);
    }
    ...
    private void updateTextViews(int r9) {
        ...
        L_0x002e:
            ...
            int r5 = com.google.android.material.C0774R.layout.material_clockface_textview
        ...
        L_0x0042:
            ...
            r5 = r5[r2]
            r3.setText(r5)
            int r5 = com.google.android.material.C0774R.C0777id.material_value_index
