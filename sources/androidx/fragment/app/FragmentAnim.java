...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean enter, boolean isPop) {
        ...
        if (!(fragment.mContainer == null || fragment.mContainer.getTag(C0343R.C0346id.visible_removing_fragment_view_tag) == null)) {
            fragment.mContainer.setTag(C0343R.C0346id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int transit, boolean enter) {
        switch (transit) {
            case FragmentTransaction.TRANSIT_FRAGMENT_OPEN /*4097*/:
                return enter ? C0343R.animator.fragment_open_enter : C0343R.animator.fragment_open_exit;
            case FragmentTransaction.TRANSIT_FRAGMENT_FADE /*4099*/:
                return enter ? C0343R.animator.fragment_fade_enter : C0343R.animator.fragment_fade_exit;
            case 8194:
                return enter ? C0343R.animator.fragment_close_enter : C0343R.animator.fragment_close_exit;
            default:
                return -1;
        }
    }
