...
class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        switch (C03972.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()]) {
            case 1:
                break;
            case 2:
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0343R.C0346id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
    ...
    public void createView() {
        ...
        L_0x00c6:
            ...
            androidx.fragment.app.Fragment r3 = r9.mFragment
            android.view.View r3 = r3.mView
            int r6 = androidx.fragment.C0343R.C0346id.fragment_container_view_tag
