...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C0343R.styleable.Fragment);
        if (fname == null) {
            fname = a.getString(C0343R.styleable.Fragment_android_name);
        }
        int id = a.getResourceId(C0343R.styleable.Fragment_android_id, -1);
        String tag = a.getString(C0343R.styleable.Fragment_android_tag);
        a.recycle();
