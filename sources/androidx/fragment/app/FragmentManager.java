...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0343R.C0346id.fragment_container_view_tag);
        ...
        if (!allowReordering2 && this.mCurState >= 1) {
            if (USE_STATE_MANAGER) {
                for (int index = startIndex; index < i6; index++) {
                    ...
                    while (it.hasNext()) {
                        Fragment fragment = ((FragmentTransaction.C0399Op) it.next()).mFragment;
            ...
            for (int index2 = startIndex; index2 < i6; index2++) {
                ...
                if (isPop) {
                    for (int opIndex = record2.mOps.size() - 1; opIndex >= 0; opIndex--) {
                        Fragment fragment2 = ((FragmentTransaction.C0399Op) record2.mOps.get(opIndex)).mFragment;
                        if (fragment2 != null) {
                    ...
                    while (it2.hasNext()) {
                        Fragment fragment3 = ((FragmentTransaction.C0399Op) it2.next()).mFragment;
                        if (fragment3 != null) {
    ...
    private void setVisibleRemovingFragment(Fragment f) {
        ...
        if (container != null && f.getEnterAnim() + f.getExitAnim() + f.getPopEnterAnim() + f.getPopExitAnim() > 0) {
            if (container.getTag(C0343R.C0346id.visible_removing_fragment_view_tag) == null) {
                container.setTag(C0343R.C0346id.visible_removing_fragment_view_tag, f);
            }
            ((Fragment) container.getTag(C0343R.C0346id.visible_removing_fragment_view_tag)).setPopDirection(f.getPopDirection());
        }
    }
