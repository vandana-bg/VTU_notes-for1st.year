...
import androidx.fragment.C0343R;
...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup container, SpecialEffectsControllerFactory factory) {
        Object controller = container.getTag(C0343R.C0346id.special_effects_controller_view_tag);
        ...
        container.setTag(C0343R.C0346id.special_effects_controller_view_tag, newController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            public void applyState(View view) {
                switch (C04183.f76xe493b431[ordinal()]) {
                    case 1:
        ...
        public final void mergeWith(State finalState, LifecycleImpact lifecycleImpact) {
            switch (C04183.f75xb9e640f0[lifecycleImpact.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C04183 {
        ...
        static {
            ...
            try {
                f75xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f75xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f76xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f76xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f76xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
