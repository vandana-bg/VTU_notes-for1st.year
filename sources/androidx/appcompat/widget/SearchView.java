...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0052R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0052R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        inflater.inflate(a.getResourceId(C0052R.styleable.SearchView_layout, C0052R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(findViewById, a.getDrawable(C0052R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a.getDrawable(C0052R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a.getDrawable(C0052R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a.getDrawable(C0052R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a.getDrawable(C0052R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a.getDrawable(C0052R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a.getDrawable(C0052R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0052R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0052R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0052R.styleable.SearchView_suggestionRowLayout, C0052R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0052R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0052R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0052R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0052R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0052R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0052R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0052R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0052R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C0052R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0052R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0052R.attr.autoCompleteTextViewStyle);
        }
