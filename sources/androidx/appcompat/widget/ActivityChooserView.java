...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0052R.styleable.ActivityChooserView, defStyle, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0052R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0052R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0052R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        ...
        FrameLayout expandButton = (FrameLayout) findViewById(C0052R.C0055id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0052R.C0055id.image);
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(getContext().getString(C0052R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    if (convertView == null || convertView.getId() != C0052R.C0055id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0052R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0052R.C0055id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0052R.C0055id.title)).setText(activity.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0052R.layout.abc_activity_chooser_view_list_item, parent, false);
                    convertView2.setId(1);
                    ((TextView) convertView2.findViewById(C0052R.C0055id.title)).setText(ActivityChooserView.this.getContext().getString(C0052R.string.abc_activity_chooser_view_see_all));
                    return convertView2;
                default:
                    throw new IllegalArgumentException();
            }
