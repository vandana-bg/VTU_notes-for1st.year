...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, (AttributeSet) null, C0052R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0052R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        /*
            ...
            goto L_0x003b
        L_0x0029:
            int r2 = androidx.appcompat.C0052R.styleable.Spinner_popupTheme
        ...
        L_0x00a6:
            ...
            r1.<init>()
            r6.mPopup = r1
            int r2 = androidx.appcompat.C0052R.styleable.Spinner_android_prompt
            java.lang.String r2 = r0.getString(r2)
            r1.setPromptText(r2)
        L_0x00b7:
            int r1 = androidx.appcompat.C0052R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r1 = r0.getTextArray(r1)
            if (r1 == 0) goto L_0x00cf
            android.widget.ArrayAdapter r2 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r2.<init>(r7, r3, r1)
            int r3 = androidx.appcompat.C0052R.layout.support_simple_spinner_dropdown_item
