...
import androidx.lifecycle.viewmodel.C0449R;
...
public class ViewTreeViewModelStoreOwner {
    ...
    public static void set(View view, ViewModelStoreOwner viewModelStoreOwner) {
        view.setTag(C0449R.C0450id.view_tree_view_model_store_owner, viewModelStoreOwner);
    }
    ...
    public static androidx.lifecycle.ViewModelStoreOwner get(android.view.View r4) {
        /*
            int r0 = androidx.lifecycle.viewmodel.C0449R.C0450id.view_tree_view_model_store_owner
        ...
        L_0x000f:
            ...
            int r3 = androidx.lifecycle.viewmodel.C0449R.C0450id.view_tree_view_model_store_owner
