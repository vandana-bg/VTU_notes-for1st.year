...
public class ViewCompat {
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0238R.C0241id.tag_accessibility_actions);
        if (actions != null) {
            return actions;
        }
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
        view.setTag(C0238R.C0241id.tag_accessibility_actions, actions2);
        return actions2;
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] mimeTypes, OnReceiveContentListener listener) {
        ...
        view.setTag(C0238R.C0241id.tag_on_receive_content_mime_types, mimeTypes2);
        view.setTag(C0238R.C0241id.tag_on_receive_content_listener, listener);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat payload) {
        ...
        OnReceiveContentListener listener = (OnReceiveContentListener) view.getTag(C0238R.C0241id.tag_on_receive_content_listener);
        if (listener == null) {
    ...
    static class CompatImplApi28 {
        ...
        static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0238R.C0241id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0238R.C0241id.tag_unhandled_key_listeners, viewListeners);
            }
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0238R.C0241id.tag_unhandled_key_listeners);
        if (viewListeners == null) {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m9at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0238R.C0241id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0238R.C0241id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View v, final OnApplyWindowInsetsListener listener) {
            if (Build.VERSION.SDK_INT < 30) {
                v.setTag(C0238R.C0241id.tag_on_apply_window_listener, listener);
            }
            if (listener == null) {
                v.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) v.getTag(C0238R.C0241id.tag_window_insets_animation_callback));
            } else {
        ...
        static void callCompatInsetAnimationCallback(WindowInsets insets, View v) {
            View.OnApplyWindowInsetsListener insetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(C0238R.C0241id.tag_window_insets_animation_callback);
