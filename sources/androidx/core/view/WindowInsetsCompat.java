...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m7of(left, top, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m8of(systemWindowInsets)).build();
    }
    ...
    private static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int type, boolean ignoreVisibility) {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        return Insets.m7of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
                    }
                    return Insets.m7of(0, getSystemWindowInsets().top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m7of(Math.max(rootStable.left, stable.left), 0, Math.max(rootStable.right, stable.right), Math.max(rootStable.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m7of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable2.bottom) {
                        return Insets.m7of(0, 0, 0, systemWindow2.bottom);
                    }
                    ...
                    return Insets.m7of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                case 16:
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m7of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        private Insets getVisibleInsets(View rootView) {
            if (Build.VERSION.SDK_INT < 30) {
                ...
                try {
                    ...
                    if (visibleRect != null) {
                        return Insets.m8of(visibleRect);
                    }
                    return null;
        ...
        public boolean equals(Object o) {
            ...
            return ColorUtils$$ExternalSynthetic0.m6m0(this.mRootViewVisibleInsets, ((Impl20) o).mRootViewVisibleInsets);
        }
    }
    ...
    private static class Impl28 extends Impl21 {
        ...
        public boolean equals(Object o) {
            ...
            if (!ColorUtils$$ExternalSynthetic0.m6m0(this.mPlatformInsets, otherImpl28.mPlatformInsets) || !ColorUtils$$ExternalSynthetic0.m6m0(this.mRootViewVisibleInsets, otherImpl28.mRootViewVisibleInsets)) {
                return false;
            }
            return true;
        }
    ...
    static Insets insetInsets(Insets insets, int left, int top, int right, int bottom) {
        ...
        return Insets.m7of(newLeft, newTop, newRight, newBottom);
    }
            ...
            try {
                ...
                if (attachInfo != null) {
                    ...
                    if (!(stableInsets == null || visibleInsets == null)) {
                        WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m8of(stableInsets)).setSystemWindowInsets(Insets.m8of(visibleInsets)).build();
