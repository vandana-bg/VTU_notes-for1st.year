...
public final class Insets {
    ...
    /* renamed from: of */
    public static Insets m7of(int left2, int top2, int right2, int bottom2) {
    ...
    /* renamed from: of */
    public static Insets m8of(Rect r) {
        return m7of(r.left, r.top, r.right, r.bottom);
    }

    public static Insets add(Insets a, Insets b) {
        return m7of(a.left + b.left, a.top + b.top, a.right + b.right, a.bottom + b.bottom);
    }
    ...
    public static Insets max(Insets a, Insets b) {
        return m7of(Math.max(a.left, b.left), Math.max(a.top, b.top), Math.max(a.right, b.right), Math.max(a.bottom, b.bottom));
    }

    public static Insets min(Insets a, Insets b) {
        return m7of(Math.min(a.left, b.left), Math.min(a.top, b.top), Math.min(a.right, b.right), Math.min(a.bottom, b.bottom));
    }
