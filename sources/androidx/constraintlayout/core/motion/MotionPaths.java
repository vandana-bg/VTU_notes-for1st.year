...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float position4 = motionPaths.f19y;
        float endCenterX = motionPaths2.f18x + (f / 2.0f);
        float endCenterY = motionPaths2.f19y + (f3 / 2.0f);
        float pathVectorX = endCenterX - (f5 + (f2 / 2.0f));
        float pathVectorY = endCenterY - (position4 + (f4 / 2.0f));
        this.f18x = (float) ((int) ((f5 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) ((position4 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        ...
        this.mMode = 0;
        this.f18x = (float) ((int) (((motionPaths.f18x + (pathVectorX * dxdx)) + (pathVectorY * dxdy)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) (((motionPaths.f19y + (pathVectorX * dydx)) + (pathVectorY * dydy)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void setupRelative(Motion mc, MotionPaths relative) {
        double dx = (double) (((this.f18x + (this.width / 2.0f)) - relative.f18x) - (relative.width / 2.0f));
        double dy = (double) (((this.f19y + (this.height / 2.0f)) - relative.f19y) - (relative.height / 2.0f));
    ...
    public void initScreen(int parentWidth, int parentHeight, MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f18x;
        float f6 = position2;
        float position3 = motionPaths.f19y;
        float endCenterX = motionPaths2.f18x + (f / 2.0f);
        float endCenterY = motionPaths2.f19y + (f3 / 2.0f);
        this.f18x = (float) ((int) ((f5 + ((endCenterX - (f5 + (f2 / 2.0f))) * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) ((position3 + ((endCenterY - (position3 + (f4 / 2.0f))) * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        this.height = (float) ((int) (f4 + (scaleY * scaleHeight)));
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f18x = (float) ((int) (motionKeyPosition.mPercentX * ((float) ((int) (((float) parentWidth) - this.width)))));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f19y = (float) ((int) (motionKeyPosition.mPercentY * ((float) ((int) (((float) parentHeight) - this.height)))));
        }
    ...
    public void initPath(MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f = motionPaths.f18x;
        float f2 = motionPaths.width;
        float f3 = motionPaths.f19y;
        float f4 = position2;
        float position3 = motionPaths.height;
        float endCenterX = motionPaths2.f18x + (motionPaths2.width / 2.0f);
        float endCenterY = motionPaths2.f19y + (motionPaths2.height / 2.0f);
        float pathVectorX = endCenterX - ((f2 / 2.0f) + f);
        float pathVectorY = endCenterY - (f3 + (position3 / 2.0f));
        this.f18x = (float) ((int) ((f + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) ((f3 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        ...
        float f6 = endCenterY;
        float f7 = (float) ((int) ((motionPaths3.f18x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f18x = f7;
        float f8 = pathVectorX;
        float f9 = (float) ((int) ((motionPaths3.f19y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.f19y = f9;
        this.f18x = f7 + ((-pathVectorY) * perpendicular);
        this.f19y = f9 + (pathVectorX * perpendicular);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
