...
public class ConstraintReference implements Reference {
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        if (target != null) {
            int i = C01931.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()];
            switch (C01931.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()]) {
                case 1:
