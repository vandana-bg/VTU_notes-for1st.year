...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f53x;
        float position3 = position2;
        float position4 = motionPaths.f54y;
        float endCenterX = motionPaths2.f53x + (f / 2.0f);
        float endCenterY = motionPaths2.f54y + (f3 / 2.0f);
        float pathVectorX = endCenterX - (f5 + (f2 / 2.0f));
        float pathVectorY = endCenterY - (position4 + (f4 / 2.0f));
        this.f53x = (float) ((int) ((f5 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f54y = (float) ((int) ((position4 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        ...
        this.mMode = 0;
        this.f53x = (float) ((int) (((motionPaths.f53x + (pathVectorX * dxdx)) + (pathVectorY * dxdy)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f54y = (float) ((int) (((motionPaths.f54y + (pathVectorX * dydx)) + (pathVectorY * dydy)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f5 = motionPaths.f53x;
        float f6 = position2;
        float position3 = motionPaths.f54y;
        float endCenterX = motionPaths2.f53x + (f / 2.0f);
        float endCenterY = motionPaths2.f54y + (f3 / 2.0f);
        this.f53x = (float) ((int) ((f5 + ((endCenterX - (f5 + (f2 / 2.0f))) * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f54y = (float) ((int) ((position3 + ((endCenterY - (position3 + (f4 / 2.0f))) * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        this.height = (float) ((int) (f4 + (scaleY * scaleHeight)));
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f53x = (float) ((int) (keyPosition.mPercentX * ((float) ((int) (((float) parentWidth) - this.width)))));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f54y = (float) ((int) (keyPosition.mPercentY * ((float) ((int) (((float) parentHeight) - this.height)))));
        }
    ...
    public void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f = motionPaths.f53x;
        float f2 = motionPaths.width;
        float f3 = motionPaths.f54y;
        float f4 = position2;
        float position3 = motionPaths.height;
        float endCenterX = motionPaths2.f53x + (motionPaths2.width / 2.0f);
        float endCenterY = motionPaths2.f54y + (motionPaths2.height / 2.0f);
        ...
        float f6 = endCenterY;
        float f7 = (float) ((int) ((motionPaths3.f53x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f53x = f7;
        float f8 = pathVectorX;
        float f9 = (float) ((int) ((motionPaths3.f54y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.f54y = f9;
        this.f53x = f7 + ((-pathVectorY) * perpendicular);
        this.f54y = f9 + (pathVectorX * perpendicular);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
            ...
            if (i2 < dArr2.length) {
                ...
                if (motionController != null) {
                    ...
                    if (!Float.isNaN(angle2)) {
                        ...
                        float path_rotate3 = rx2;
                        double d23 = (double) path_rotate2;
                        float f13 = ry;
                        float f14 = dpos_x;
                        float f15 = dpos_y;
