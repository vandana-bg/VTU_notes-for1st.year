...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0227R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0227R.styleable.Transform);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public static class PropertySet {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0227R.styleable.PropertySet);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0227R.styleable.PropertySet_android_alpha) {
                    this.alpha = a.getFloat(attr, this.alpha);
                } else if (attr == C0227R.styleable.PropertySet_android_visibility) {
                    this.visibility = a.getInt(attr, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (attr == C0227R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = a.getInt(attr, this.mVisibilityMode);
                } else if (attr == C0227R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0227R.styleable.Motion);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, override ? C0227R.styleable.ConstraintOverride : C0227R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint c = new Constraint();
        TypedArray a = context.obtainStyledAttributes(attrs, C0227R.styleable.ConstraintOverride);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < N; i++) {
            int attr = typedArray.getIndex(i);
            if (!(attr == C0227R.styleable.Constraint_android_id || C0227R.styleable.Constraint_android_layout_marginStart == attr || C0227R.styleable.Constraint_android_layout_marginEnd == attr)) {
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                tag = C0227R.C0230id.class.getField(idString).getInt((Object) null);
            } catch (Exception e) {
            }
            if (tag == 0) {
